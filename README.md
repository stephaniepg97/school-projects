...
_BOT-SpotSensors # WCF Service Application
...
_ParkTU (Parking Spots Transmission Unit) # Console Application
...
_ParkSS (Parking Spot Storage App) # Console Application
